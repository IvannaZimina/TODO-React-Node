...
function RegisterPage() {
  ...
  const [styleMsg, setStyleMsg] = useState(`${style.successRegister} ${style.hidden}`);
      ...
      <div className={style.loginContainer}>
        <div className={styleFrom}>
          ...
          <div className={style.formBlock}>
            ...
            <div className={style.backLink}> <Link to="/login"> &lt;&lt; </Link> </div>
        ...
        <div className={styleMsg}>
          ...
          <div>Enter the account <Link to="/login">here</Link></div>
        </div>
